...
//            reviewerRepository.save(Reviewer.builder().id(null).fullName("Tleulessova Agila").careerGrade("Кандидат физ-мат наук").workPlace("ЕНУ им№ Л.Н.Гумилева").profession("Ассоциированный профессор").build());
//            reviewerRepository.save(Reviewer.builder().id(null).fullName("Gulaina Shabdirova Utebayevna").careerGrade("").workPlace("Ayacom LLP").profession("IT Project Manager").build());
//            reviewerRepository.save(Reviewer.builder().id(null).fullName("Искаков Дархан").careerGrade("").workPlace("Twilio Estonia OU").profession("Разработчик").build());
//            reviewerRepository.save(Reviewer.builder().id(null).fullName("Бекбаева Айгуль").careerGrade("Магистр наук").workPlace("АПК КАТУ им.С.Сейфуллина").profession("Заместитель директора центра технологической компетенции в области цифровизации").build());
//
//
//
...
//            initialRepository.save(Initial.builder().initial("ITM").build());
//
...
//            groupRepository.save(new Group(null, "ITM-1903", initialRepository.findByInitial("ITM")));
//            groupRepository.save(new Group(null, "ITM-1904", initialRepository.findByInitial("ITM")));
//
//
...
//                    .name("Design and development of a platform for cryptocurrency trading using decentralized exchanges")
...
//                    .name("Абдразак + Өтеген + Сабырбек")
//                    .confirmed(true)
//                    .creator(userRepository.findByUsername("saberbekm").get())
//                    .advisor(userRepository.findByUsername("ikramm").get())
//                    .reviewer(reviewerRepository.findByFullName("Алибек Полатов"))
//                    .build());
//
//            userTeamRepository.save(new UserTeam(null, userRepository.findByUsername("abdirazakb").get(), teamRepository.findTeamByName("Абдразак + Өтеген + Сабырбек"), true));
//            userTeamRepository.save(new UserTeam(null, userRepository.findByUsername("otegena").get(),  teamRepository.findTeamByName("Абдразак + Өтеген + Сабырбек"), true));
//            userTeamRepository.save(new UserTeam(null, userRepository.findByUsername("saberbekm").get(),  teamRepository.findTeamByName("Абдразак + Өтеген + Сабырбек"), true));
//
//            teamTopicRepository.save(TeamTopic.builder()
//                    .topic(topicRepository.findByName("Design and development of a platform for cryptocurrency trading using decentralized exchanges"))
//                    .team(teamRepository.findTeamByName("Абдразак + Өтеген + Сабырбек"))
//                    .approved(true)
//                    .build());
//
//            Team team1 = teamRepository.findTeamByName("Абдразак + Өтеген + Сабырбек");
//            team1.setTopic(topicRepository.findByName("Design and development of a platform for cryptocurrency trading using decentralized exchanges"));
...
//
//            topicRepository.save(Topic.builder()
//                    .name("Development and analysis of an automated bot for trading operations with cryptocurrency")
...
//
//            teamRepository.save(Team.builder()
//                    .name("Байдолда + Подлесный")
//                    .confirmed(true)
//                    .creator(userRepository.findByUsername("baidoldam").get())
//                    .advisor(userRepository.findByUsername("kalpakove").get())
//                    .reviewer(reviewerRepository.findByFullName("Tleulessova Agila"))
//                    .build());
//
//            userTeamRepository.save(new UserTeam(null, userRepository.findByUsername("baidoldam").get(), teamRepository.findTeamByName("Байдолда + Подлесный"), true));
//            userTeamRepository.save(new UserTeam(null, userRepository.findByUsername("podlesnya").get(),  teamRepository.findTeamByName("Байдолда + Подлесный"), true));
//
//            teamTopicRepository.save(TeamTopic.builder()
//                    .topic(topicRepository.findByName("Development and analysis of an automated bot for trading operations with cryptocurrency"))
//                    .team(teamRepository.findTeamByName("Байдолда + Подлесный"))
//                    .approved(true)
//                    .build());
//
//            Team team2 = teamRepository.findTeamByName("Байдолда + Подлесный");
//            team2.setTopic(topicRepository.findByName("Development and analysis of an automated bot for trading operations with cryptocurrency"));
...
//
//            topicRepository.save(Topic.builder()
//                    .name("Development Client- server application for accounting of fixed assets")
...
//                    .firstName("Алибек")
//                    .lastName("Тусупбеков")
//                    .middleName("Сержанович")
//                    .username("tussupbekov")
//                    .isHonor(false)
//                    .role(roleRepository.findByName("ROLE_STUDENT"))
//                    .password(new BCryptPasswordEncoder().encode("verySecret3$"))
//                    .group(groupRepository.findByInitialInitialAndName("SE", "SE-1903"))
...
//
//            teamRepository.save(Team.builder()
//                    .name("Ракат + Серікұлы + Тусупбеков")
//                    .confirmed(true)
//                    .creator(userRepository.findByUsername("tussupbekov").get())
//                    .advisor(userRepository.findByUsername("adamovaa").get())
//                    .reviewer(reviewerRepository.findByFullName("Жартыбаева Макпал Галымбековн"))
//                    .build());
//
//            userTeamRepository.save(new UserTeam(null, userRepository.findByUsername("rakatd").get(), teamRepository.findTeamByName("Ракат + Серікұлы + Тусупбеков"), true));
//            userTeamRepository.save(new UserTeam(null, userRepository.findByUsername("serikulyb").get(), teamRepository.findTeamByName("Ракат + Серікұлы + Тусупбеков"), true));
//            userTeamRepository.save(new UserTeam(null, userRepository.findByUsername("tussupbekov").get(), teamRepository.findTeamByName("Ракат + Серікұлы + Тусупбеков"), true));
//
//            teamTopicRepository.save(TeamTopic.builder()
//                    .topic(topicRepository.findByName("Development Client- server application for accounting of fixed assets"))
//                    .team(teamRepository.findTeamByName("Ракат + Серікұлы + Тусупбеков"))
//                    .approved(true)
//                    .build());
//
//            Team team3 = teamRepository.findTeamByName("Ракат + Серікұлы + Тусупбеков");
//            team3.setTopic(topicRepository.findByName("Development Client- server application for accounting of fixed assets"));
...
//
//            topicRepository.save(Topic.builder()
//                    .name("Application of deep learning algorithm for OCT image analysis")
//                    .creator(userRepository.findByUsername("harmysov").get())
//                    .selected(true)
//                    .build());
//
//            userRepository.save(User.builder()
...
//
//            teamRepository.save(Team.builder()
//                    .name("Мұхтарқызы + Хамитұлы")
//                    .confirmed(true)
//                    .creator(userRepository.findByUsername("muratkyzysh").get())
//                    .advisor(userRepository.findByUsername("harmysov").get())
//                    .reviewer(reviewerRepository.findByFullName("Gulaina Shabdirova Utebayevna"))
//                    .build());
//
//            userTeamRepository.save(new UserTeam(null, userRepository.findByUsername("muratkyzysh").get(), teamRepository.findTeamByName("Мұхтарқызы + Хамитұлы"), true));
//            userTeamRepository.save(new UserTeam(null, userRepository.findByUsername("hamitulyb").get(),  teamRepository.findTeamByName("Мұхтарқызы + Хамитұлы"), true));
//
//            teamTopicRepository.save(TeamTopic.builder()
//                    .topic(topicRepository.findByName("Application of deep learning algorithm for OCT image analysis"))
//                    .team(teamRepository.findTeamByName("Мұхтарқызы + Хамитұлы"))
//                    .approved(true)
//                    .build());
//
//            Team team4 = teamRepository.findTeamByName("Мұхтарқызы + Хамитұлы");
//            team4.setTopic(topicRepository.findByName("Application of deep learning algorithm for OCT image analysis"));
...
//                    .firstName("Г.")
//                    .lastName("Шажалиева")
//                    .username("shazhalievag")
//                    .role(roleRepository.findByName("ROLE_ADVISOR"))
//                    .password(new BCryptPasswordEncoder().encode("verySecret3$"))
//                    .build());
//
//            topicRepository.save(Topic.builder()
//                    .name("Development of a system “EtaHealth”")
//                    .creator(userRepository.findByUsername("shazhalievag").get())
//                    .selected(true)
//                    .build());
//
//            userRepository.save(User.builder()
...
//                    .id(null)
//                    .firstName("Еркежан")
//                    .lastName("Бакытжанова")
//                    .middleName("")
//                    .username("bakytzhanovae")
//                    .isHonor(false)
//                    .role(roleRepository.findByName("ROLE_STUDENT"))
//                    .password(new BCryptPasswordEncoder().encode("verySecret3$"))
//                    .group(groupRepository.findByInitialInitialAndName("ITM", "ITM-1901"))
//                    .build());
//
//
//            teamRepository.save(Team.builder()
//                    .name("Айдархан + Бакытжанова")
//                    .confirmed(true)
//                    .creator(userRepository.findByUsername("aidarkhano").get())
//                    .advisor(userRepository.findByUsername("shazhalievag").get())
//                    .reviewer(reviewerRepository.findByFullName("Искаков Дархан"))
//                    .build());
//
//            userTeamRepository.save(new UserTeam(null, userRepository.findByUsername("aidarkhano").get(), teamRepository.findTeamByName("Айдархан + Бакытжанова"), true));
//            userTeamRepository.save(new UserTeam(null, userRepository.findByUsername("bakytzhanovae").get(), teamRepository.findTeamByName("Айдархан + Бакытжанова"), true));
//
//            teamTopicRepository.save(TeamTopic.builder()
//                    .topic(topicRepository.findByName("Development of a system “EtaHealth”"))
//                    .team(teamRepository.findTeamByName("Айдархан + Бакытжанова"))
//                    .approved(true)
//                    .build());
//
//            Team team5 = teamRepository.findTeamByName("Айдархан + Бакытжанова");
//            team5.setTopic(topicRepository.findByName("Development of a system “EtaHealth”"));
...
//
//            topicRepository.save(Topic.builder()
//                    .name("Planning and Development of an information system for compiling dynamic models of inter-industry balance")
//                    .creator(userRepository.findByUsername("soltang").get())
//                    .selected(true)
//                    .build());
//
//            userRepository.save(User.builder()
...
//                    .role(roleRepository.findByName("ROLE_STUDENT"))
//                    .password(new BCryptPasswordEncoder().encode("verySecret3$"))
//                    .group(groupRepository.findByInitialInitialAndName("ITM", "ITM-1904"))
//                    .build());
//
//
//            teamRepository.save(Team.builder()
//                    .name("Абитбек + Әділ + Оралбай")
//                    .confirmed(true)
//                    .creator(userRepository.findByUsername("abitbeka").get())
//                    .advisor(userRepository.findByUsername("soltang").get())
//                    .reviewer(reviewerRepository.findByFullName("Бекбаева Айгуль"))
//                    .build());
//
//            userTeamRepository.save(new UserTeam(null, userRepository.findByUsername("abitbeka").get(), teamRepository.findTeamByName("Абитбек + Әділ + Оралбай"), true));
//            userTeamRepository.save(new UserTeam(null, userRepository.findByUsername("adila").get(), teamRepository.findTeamByName("Абитбек + Әділ + Оралбай"), true));
//            userTeamRepository.save(new UserTeam(null, userRepository.findByUsername("oralbais").get(),  teamRepository.findTeamByName("Абитбек + Әділ + Оралбай"), true));
//
//            teamTopicRepository.save(TeamTopic.builder()
//                    .topic(topicRepository.findByName("Planning and Development of an information system for compiling dynamic models of inter-industry balance"))
//                    .team(teamRepository.findTeamByName("Абитбек + Әділ + Оралбай"))
//                    .approved(true)
//                    .build());
//
//            Team team6 = teamRepository.findTeamByName("Абитбек + Әділ + Оралбай");
//            team6.setTopic(topicRepository.findByName("Planning and Development of an information system for compiling dynamic models of inter-industry balance"));
